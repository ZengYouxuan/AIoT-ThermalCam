...
namespace ThermalCam
{
    ...
    */
    ...
    class MessageBody
    {
        ...
        public float Temperature_Threshhold { get; set; }

        [JsonProperty(PropertyName = "min_temp")]
        public float Sensor_Temperature_Min { get; set; }

        [JsonProperty(PropertyName = "max_temp")]
        public float Sensor_Temperature_Max { get; set; }

        [JsonProperty(PropertyName = "ir_temp")]
        public float Sensor_Temperature_Reading { get; set; }

        [JsonProperty(PropertyName = "veri_temp")]
        public float Subject_Temperature_Verification { get; set; }
        ...
        [JsonProperty(PropertyName = "edge_device_id")]
